...
public class OI {
    ...
    public JoystickButton resetWheels;
    public JoystickButton bothWindowMotorNegative;
    public JoystickButton BPUliftUp;
    public JoystickButton BPUliftDown;
    public JoystickButton catapultUp;
    public JoystickButton catapultDown;
    public JoystickButton fullPower; 
    public OI() {
        ...
        fullPower= new JoystickButton(joystick1, 5);
        fullPower.whileHeld(new fullPower());
        ...
        BPUliftUp = new JoystickButton(joystick1, 3);
        BPUliftUp.whileHeld(new BPUliftUp());
        BPUliftDown = new JoystickButton(joystick1, 4);
        BPUliftDown.whileHeld(new BPUliftDown());
        
        catapultUp = new JoystickButton(joystick1, 5);
        catapultUp.whileHeld(new catapultpos());
        catapultDown = new JoystickButton(joystick1, 6);
        
     //   resetWheels= new JoystickButton(joystick1, 13);
       // resetWheels.whenPressed(new resetWheels());
   ...
   // public double getY() {
    ...
    //}
    public double getX() {
    	//System.out.=Xprintln("I Think I am getting Right Axis (Axis5)");
    	//System.out.println("Left is supposed to be CAN2");
    	//return logitechXBox.getRawAxis(3);  Hey sometimes is Axis 3
    	return joystick1.getRawAxis(0);
    }
