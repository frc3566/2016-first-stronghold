...
//public static Ztwist ztwist;
    ...
    endGameWinch = new EndGameWinch();
       ...
       chooser.addDefault("The Fantastic Gillian", new Sallyport());
       chooser.addObject("ChevaldeFries", new ChevaldeFries());
       chooser.addObject("DrawBridge", new DrawBridge());
       chooser.addObject("LowBar", new LowBar());
       chooser.addObject("Moat", new Moat());
       chooser.addObject("Rampart", new Rampart());
       chooser.addObject("Sallyport", new Sallyport());
       chooser.addObject("RoughTerrain", new RoughTerrain());
