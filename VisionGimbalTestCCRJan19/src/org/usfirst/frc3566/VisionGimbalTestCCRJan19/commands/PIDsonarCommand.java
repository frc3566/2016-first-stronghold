...
*
*/
public class PIDsonarCommand extends PIDCommand {
 ...
 public PIDsonarCommand() {

 // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
     // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PID
     super("PIDsonarCommand", 80.0, 0.0, 0.0, 0.02);
 ...
 protected void usePIDOutput(double output) {
    ...
    // RobotMap.driveTrainCANTalon1.pidWrite(output);///////////////*********!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
