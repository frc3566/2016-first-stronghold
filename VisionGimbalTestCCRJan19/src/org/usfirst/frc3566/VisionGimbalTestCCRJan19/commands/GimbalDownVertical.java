 ...
 *
 */
public class GimbalDownVertical extends Command {
    ...
    protected void initialize() {
    	...
    	//System.out.println("Hi from Gimbal Down command");
    	this.setTimeout(RobotMap.GIMBAL_TIMEOUT);
    	Robot.verticalGimbalTurning.moveVerticalDown();
    }
