...
import org.usfirst.frc3566.VisionGimbalTestCCRJan19.commands.setPotentiometerCenter;
...
public class OI {
	 ...
	 * Button 1 = Button 4 on the controller
	 * Button 4 = Trigger Button on the Controller
	 * Button 3 = Button 3 on the Controller 
	 * Button 5 = Button 5 on controller
	 * Button 6 = Button 6 on the Controller 
	 * 
	 */ 
    ...
    public JoystickButton button1VerticalDown;
    ...
    public OI() {
        ...
        button1VerticalDown = new JoystickButton(logitechXBox, 1);
        button1VerticalDown.whileHeld(new GimbalDownVertical());
        button4VerticalUp = new JoystickButton(logitechXBox, 4);
        button4VerticalUp.whileHeld(new GimbalUpVertical());
        button6HorizRight = new JoystickButton(logitechXBox, 6);
        button6HorizRight.whileHeld(new GimbalRightHorizontal());
        button5HorizLeft = new JoystickButton(logitechXBox, 5);
  ...
  //      buttonConstantRotation.whenPressed(new GimballConstantHorizontalRotation()); // Danger on Blue Boton DO NOT TOUCH or you break robot 
        ...
        button2PotentiometerCenter = new JoystickButton(logitechXBox, 2);
        button2PotentiometerCenter.whenPressed(new setPotentiometerCenter());
  ...
  //  public double getLeftStick(){
    ...
    //System.out.println("I Think I am getting Left Axis (Axis1)");
    	...
    	return logitechXBox.getRawAxis(1);
    			
    }
    public double getY() {
    	return logitechXBox.getRawAxis(0);
    }
